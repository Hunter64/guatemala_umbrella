  ...
  def render(assigns) do
    ~H"""
      <div>
        ...
        <% else %>
          <div class="w-full">
            <%= if @edit, do: live_component(GuatemalaWeb.FormEditCustomersComponent, id: @customer_id_edit, new: false, edit: true, list: false, filters_to_return_from_edit: @filters_to_return_from_edit) %>
          </div>
        <% end %>
      </div>
    """
