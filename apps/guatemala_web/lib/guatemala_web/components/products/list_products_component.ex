                  ...
                  <tbody>
                    <%= for item <- @all_products do %>
                      <%= if item.id == (@data_details |> Map.get(:id)) && @show_details do %>
                        <tr class="border-t-2 border-t-stone-700 dark:border-t-gray-100 border-l-2 border-l-stone-700 dark:border-l-gray-100 border-r-2 border-r-stone-700 dark:border-r-gray-100 bg-stone-300 dark:bg-gray-700 cursor-pointer" phx-click="show_details" phx-value-data={item.id} phx-target="#list_products">
